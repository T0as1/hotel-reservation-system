    ...
    public class Guest extends User implements Payable {
        ...
        public void setDateOfBirth(LocalDate dateOfBirth) {
            ...
            if (dateOfBirth.plusYears(18).isAfter(LocalDate.now())) {
                throw new DobException("Only 18+ are allowed to register");
            }

            if (dateOfBirth.getYear() < 1900) {
                throw new DobException("Date of birth cannot be earlier than 1900");
            }
        ...
        public Invoice checkout(Reservation res, PaymentMethod method) {
            double amount = res.calculateTotalCost();
            ...
            Invoice invoice = new Invoice(HotelDatabase.getAllInvoices().size() + 1, res);
            ...
            while (loggedIn) {
                ...
                switch (choice){
                    ...
                    case "2": try{
                        ...
                        if (selectRoom != null && HotelDatabase.isRoomAvailableForDates(selectRoom, inDate, outDate)) {
                    ...
                    case "5":
                        ...
                        if (resToOut != null && resToOut.getGuest().equals(this)) {
                            if (resToOut.getStatus() != ReservationStatus.CHECKED_IN) {
                                System.out.println("You must check in before checkout.");
                                break;
                            }
